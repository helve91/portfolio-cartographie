...
---
# Méthode 1: Méthode K-means (classification non-supervisée)<br>
## Mosaïque et calcul K-means sur GEE<br>
...
Un nombre plus grand de couches pourrait être envisagé car toutes les parties du TNS n'ont pas la même amplitude QGIS ne supportant pas les opérations trop lourdes, les étapes sus-mentionnées seront réalsées en JavaScript sur Google Earth Engine:
...
Les 48 images sont ensuite extraites de Google Drive pour être traitées dans QGIS: c'est là que l'utilisateur va rassembler les 20 classes.
...
En se servant des images NIR (proche-infrarouge) qui distinguent bien l'agroforesterie (ou se trouve le cacao) et du NDVI, l'utilisateur pourra trier la ou les classes qui sont le plus susceptibles d'en faire partie.

## Lissage pour la cartographie
